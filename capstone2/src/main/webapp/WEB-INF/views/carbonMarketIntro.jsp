						...
						<div>
							<div class="pt-3 ps-3 pe-3 context">
								...
								<div class="pt-1 d-flex">
									...
									<div>배출권 거래제에 참여하고 있는 기업들이 탄소 배출권을 거래하기 위해 형성된 거래소. 한국은 현재 한국거래소(KRX) 에서 운영중이다.</div>
								</div>
								<div class="fs-2 border-bottom border-2 border-dark-subtle pt-5">배출권 거래제란?</div>
								<div class="pt-1 d-flex">
									<span class="drag-block dot">&#183;</span>
									<div>탄소 배출량이 증가함에 따라 탄소중립을 실현하기 위해 배출권 거래제 회원에서 시행하는 제도이다.</div>
								</div>
								...
								<div class="pt-1 d-flex">
									<span class="drag-block dot">&#183;</span>
									<div>배출권 거래제 회원은 매년 탄소 배출량을 인증하고 인증된 배출량에 따라 여유분과 부족분이 생기게 된다.</div>
								</div>
								<div class="pt-1 d-flex">
									<span class="drag-block dot">&#183;</span>
									<div>
										여유분은 <span class="text-primary">탄소배출권으로 타 기업에게 판매</span>가 가능하고 <span class="text-danger">부족분은 탄소 배출권을 구매</span>하여 채워야 한다.
									</div>
								</div>
								...
								<div class="pt-5 d-flex justify-content-between item-aligns-center">
									<span class="fs-6 fw-bold">출처</span><a href="https://ets.krx.co.kr/main/main.jsp">배출권시장 정보 플랫폼</a>
								</div>
							</div>
						</div>
					</div>
