...
<%
String buttonAble = request.getParameter("buttonAble");
boolean isbuttonAble = buttonAble.equals("true");
pageContext.setAttribute("isbuttonAble", isbuttonAble);
%>
